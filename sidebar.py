...
st.sidebar.title("Climate Finance Maturity Tool")
tabs = ["Instructions", "Summary & Recommendations", "Enabling Environment", "Ecosystem Infrastructure", "Finance Providers", "Finance Seekers"]
...
# --- Other Dimensions: Ecosystem Infrastructure, Finance Providers, Finance Seekers ---
# Repeat the same process for the other dimensions as shown for Enabling Environment.
